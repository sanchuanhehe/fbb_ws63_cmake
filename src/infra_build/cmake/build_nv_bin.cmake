...
if(${NV_UPDATE})
    ...
    add_custom_command(
        ...
        COMMAND ${CMAKE_COMMAND} -E env
            ...
            ${Python3_EXECUTABLE} ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/build_nvbin.py ${TARGET_NAME}
        COMMENT "update nv bin"
        WORKING_DIRECTORY ${ROOT_DIR}
        DEPENDS GENERAT_BIN ${NV_UPDATE_EXTRA_DEPENDS} ${FBB_CONTRACT_FILE} ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/build_nvbin.py
        VERBATIM
    )
