...
set(SCRIPT_DIR "${ROOT_DIR}/infra_build/script")
...
# concat tool
set(CONCAT_TOOL ${SCRIPT_DIR}/concat_bin.py)

# build nv tool
set(BUILD_NV_TOOL ${SCRIPT_DIR}/build_nvbin.py)
set(BUILD_NV_GEN_UTILS ${SCRIPT_DIR}/nv/generate_utils.py)
