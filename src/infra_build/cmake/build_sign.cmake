...
if (EXISTS ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/sign_config/${BUILD_TARGET_NAME}.cfg)
    set(SIGN_CONFIG_FILE ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/sign_config/${BUILD_TARGET_NAME}.cfg)
...
add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E env
        ...
        ${Python3_EXECUTABLE} ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/sign_config/params_and_bin_sign.py ${TARGET_NAME}
    COMMENT "ws63 image sign"
    WORKING_DIRECTORY ${PROJECT_BINARY_DIR}
    DEPENDS GENERAT_BIN ${GENERAT_ROM_PATCH} ${FBB_CONTRACT_FILE} ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/sign_config/params_and_bin_sign.py
    VERBATIM
)
...
add_custom_command(
    ...
    COMMAND sh ${ROOT_DIR}/infra_build/config/target_config/${CHIP}/sign_config/params_and_bin_sign.sh
