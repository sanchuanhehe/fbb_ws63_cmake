...
def build_contract(env_data, cmake_binary_dir):
    ...
    return {
        ...
        "stages": {
            "configure": {
                "inputs": [
                    "infra_build/script/export_target_env.py",
                    "infra_build/config/target_config"
                ],
                "outputs": [
            ...
            "postbuild": {
                "inputs": [
                    "infra_build/cmake/build_sign.cmake",
                    "infra_build/cmake/build_nv_bin.cmake",
                    "infra_build/cmake/build_hso_database.cmake"
                ],
                "outputs": [
                    target_output_dir,
            ...
            "package": {
                "inputs": [
                    "tools/pkg/packet.py",
                    f"infra_build/config/target_config/{chip}/build_{chip}_update.py"
                ],
                "outputs": [
            ...
            "sdk": {
                "inputs": [
                    "infra_build/script/sdk_generator/sdk_generator.py"
                ],
                "outputs": [
