...
script_path = os.path.join(root_path, 'infra_build', 'script')
target_config_path = os.path.join(root_path, 'infra_build', 'config', 'target_config')
output_root = os.environ.get('FBB_OUTPUT_ROOT', os.path.join(root_path, 'output'))
