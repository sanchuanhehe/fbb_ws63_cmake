...
class CMakeBuilder(BuildEnvironment):
    ...
    def build_target(self, target):
        ...
        if env.get("fs_image"):
            fs_image_path = os.path.join(root_path, 'infra_build', 'config', 'target_config', env.get('chip'), 'mk_fs_image')
    ...
    def start(self, env, target_name, output_path, nhso=None, clean=None):
        ...
        mconfig_file_path = os.path.join(root_path, 'infra_build', 'config', 'target_config', chip, 'menuconfig', core, f"{target_name}.config")
    ...
    def pack_fota(self, chip, target_name, option):
        fota_script_path = os.path.join(root_path, 'infra_build', 'config', 'target_config', chip, 'build_' + chip + '_update.py')
