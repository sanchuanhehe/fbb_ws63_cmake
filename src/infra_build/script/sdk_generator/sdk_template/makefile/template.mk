...
export HSO_MK_XML_PY:= $(SDK_ROOT)/infra_build/script/hdbxml/mk_hso_prim_xml.py
export HSO_XML_PRE_PROCESS_PY:= $(SDK_ROOT)/infra_build/script/hdbxml/process_pregenerated_xml.py
export HSO_XML_MERGE_PY:= $(SDK_ROOT)/infra_build/script/hdbxml/hso_prim_xml_merge.py
export HSO_XML_DB_CREATE_PY:= $(SDK_ROOT)/infra_build/script/hdbxml/database_create.py
export BUILD_UTILS_PY:=$(SDK_ROOT)/infra_build/script/utils/build_utils.py
