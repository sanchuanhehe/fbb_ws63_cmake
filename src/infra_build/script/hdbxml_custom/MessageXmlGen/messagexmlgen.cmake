function(messagexml TARGETDIR)
    ...
    set(MESSAGEXMLCONFIG ${CMAKE_SOURCE_DIR}/infra_build/script/hdbxml_custom/MessageXmlGen/MessageXmlGen_${CORE}.cfg)
    set(MESSAGERULES ${CMAKE_SOURCE_DIR}/infra_build/script/hdbxml_custom/MessageXmlGen/MessageRules_${CORE}.xml)
...
# 解析json时会给public_define添加-D前缀
    ...
    message(STATUS "${Python3_EXECUTABLE} ${CMAKE_SOURCE_DIR}/infra_build/script/hdbxml_custom/MessageXmlGen/MessageXmlGen.py ${MESSAGES_CPPFILE} ${MESSAGES_XML} ${MESSAGEXMLCONFIG} ${CORE} ${CORE} ${MESSAGERULES}")
    execute_process(COMMAND ${Python3_EXECUTABLE} ${CMAKE_SOURCE_DIR}/infra_build/script/hdbxml_custom/MessageXmlGen/MessageXmlGen.py ${MESSAGES_CPPFILE} ${MESSAGES_XML} ${MESSAGEXMLCONFIG} ${CORE} ${CORE} ${MESSAGERULES}
                    WORKING_DIRECTORY  ${CMAKE_SOURCE_DIR}
                    RESULT_VARIABLE RES
                    ERROR_VARIABLE ERR
                    OUTPUT_VARIABLE OUT)
