...
sys.path.append(os.path.join(root_dir, 'infra_build', 'script'))
sys.path.append(os.path.join(root_dir, 'infra_build', 'config'))
...
if __name__ == '__main__':
    ...
    BUILD_CONFIG_PATH = os.path.join(root_dir, 'infra_build', 'config', 'target_config', chip, 'image_analysis_cfg', 'module.json')
    REMOVE_SECTIONS_CONFIG_PATH = os.path.join(root_dir, 'infra_build', 'config', 'target_config', chip, 'image_analysis_cfg', "remove_sections.txt")
