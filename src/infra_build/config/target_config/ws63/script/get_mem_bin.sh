...
pushd ${WORK_DIR}
    ...
    python3 ${ROOT_PATH}/infra_build/config/target_config/ws63/script/process_sfc_hex.py ${ROOT_PATH}/output/ws63/mem_bins/FLASH.bin ${ROOT_PATH}/output/ws63/mem_bins/SFC_DATA 2097152
