...
- D. 配置完成后，点击工具“程序加载”按钮烧录，出现“Connecting, please reset device...”字样时，复位开发板（复位RST按键在开发板右边），等待烧录结束。
