...
- 1.下载安装[vscode](https://code.visualstudio.com/Download) ，选择“windows”安装，根据推荐步骤安装即可。
...
- 4.下载完成后，解压“fbb_ws63-master.zip”，右键该文件选择“解压到当前文件夹或者Extract Here”。
